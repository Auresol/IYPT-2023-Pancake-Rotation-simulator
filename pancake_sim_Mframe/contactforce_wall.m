function [Fi,fi] = contactforce_wall(ball1,container_radius,container_velocity,container_contact_velocity,incontactwithwall,delta_t)
    
    % --------------------------- %
    wall_young_modulus = 1e10;
    ...
    if incontactwithwall == true
        ...
        % vRel = -vPi
        vRel = container_contact_velocity - (ball1.velocity + cross(ball1.angular_velocity, ball1.radius * -direcvec));
